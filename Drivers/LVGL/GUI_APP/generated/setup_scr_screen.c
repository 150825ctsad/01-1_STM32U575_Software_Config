...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0x50d08e), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_sw_1, 135, 105);
    lv_obj_set_size(ui->screen_sw_1, 50, 20);
