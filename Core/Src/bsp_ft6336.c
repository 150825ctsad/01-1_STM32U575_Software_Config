...
{	
    ...
    tp_dev.tp[id1].status = (tp_dev.tp[id1].status == release) ? touch : stream;
    tp_dev.tp[id1].x = FT6336_read_touch1_x();
    tp_dev.tp[id1].y = FT6336_read_touch1_y();
    tp_dev.tp[~id1 & 0x01].status = release;
}